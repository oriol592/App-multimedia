...
public class EnregistrarAudio extends AppCompatActivity
{
	//Aquest codi l'he extret de (hi he fet modificacions): https://www.tutorialspoint.com/android/android_audio_capture.htm
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_enregistrar_audio);

		buttonStart = findViewById(R.id.botoEnregistrar);
		buttonStop = findViewById(R.id.botoStop);
		buttonPlayLastRecordAudio = findViewById(R.id.botoPlay);
		buttonStopPlayingRecording = findViewById(R.id.botoStopReproduirGrabacio);
